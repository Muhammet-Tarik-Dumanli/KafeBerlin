...
namespace KafeBerlin.Ui
{
    public partial class SiparisForm : Form
    {
        ...
        private void DetaylariListele()
        {
            ...
            _blSiparisdetaylar.ListChanged += _blSiparisdetaylar_ListChanged; //Listede değişiklik olduğunda
        ...
        {
            cboUrun.DataSource = _db.Urunler; //fiyatı ile beraber gösteriyor ToString() metodu ile
            //cboUrun.DisplayMember = "UrunAd";// Sadece ürün adını gösterir
        }
        ...
        {
            string eylem = durum == SiparisDurum.Iptal ? "siparişi iptal edilecektir" : "ödemesi alınacakır";
            string baslik = durum == SiparisDurum.Iptal ? "İptal" : "Ödeme";
            DialogResult dr = MessageBox.Show($"{_siparis.MasaNo} nolu masanın {eylem}. Emin misiniz?",
